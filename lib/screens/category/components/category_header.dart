    ...
    if (isMobileS) {
      return Column(
        ...
        children: [
          ...
          CategorySearchField(
            onChange: (val) => context.dataProvider.filterCategories(val),
          ),
        ],
      );
    }
...
// ─────────────────────────────────────────────────────────────────────────────
//  SEARCH FIELD  (identical behaviour to DashBoardHeader's SearchField)
// ─────────────────────────────────────────────────────────────────────────────
class CategorySearchField extends StatelessWidget {
  final Function(String) onChange;
  const CategorySearchField({Key? key, required this.onChange})
      : super(key: key);
