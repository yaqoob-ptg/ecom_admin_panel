  ...
  Widget build(BuildContext context) {
      ...
      return Column(
        ...
        children: [
          ...
          _NotificationSearchField(
            onChange: (val) => context.dataProvider.filterNotifications(val),
          ),
        ],
      );
    }
    ...
    return Row(
      children: [
        ...
        Expanded(
          child: _NotificationSearchField(
            onChange: (val) => context.dataProvider.filterNotifications(val),
          ),
        ),
        SizedBox(width: AppSpacing.itemGap(context)),
...
class _NotificationSearchField extends StatelessWidget {
  final Function(String) onChange;
  const _NotificationSearchField({required this.onChange});
