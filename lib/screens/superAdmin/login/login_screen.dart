...
class LoginScreenSuperAdmin extends StatefulWidget {
  const LoginScreenSuperAdmin({super.key});

  @override
  State<LoginScreenSuperAdmin> createState() => _LoginScreenSuperAdminState();
}

class _LoginScreenSuperAdminState extends State<LoginScreenSuperAdmin> {
          ...
          child: FlutterLogin(
            ...
            onLogin: (loginData) async {
              return await context.userProvider
                  .login(loginData, endpoint: 'super-admin/secure-login');
            },
            ...
            onSubmitAnimationCompleted: () async {
              ...
              if (user?.sId != null) {
                ...
                Get.offAllNamed(AppPages.SUPERADMINLOGIN);
              }
            },
