...
//   SuperadminProvider(this._dataProvider) {
//     _initSuperAdmin(); // 🔥 load on startup
//   }

//   void _initSuperAdmin() {
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       _user = getLoginUsr();
//       print(" SuperadminProvider initialized with user: $_user");
//       notifyListeners();
//     });
//   }
...
//         endpointUrl: 'super-admin/secure-login',
//         itemData: loginData,
//       );
...
//           // ── Block unverified super-admin on app side too ───────────────────────
...
//     try {
//       final response = await service.addItem(
//         endpointUrl: 'super-admin/forgot-password',
...
//   //   try {
//   //     final response = await service.addItem(
//   //       endpointUrl: 'super-admin/reset-password/$token',
//   //       itemData: {
...
//         endpointUrl: 'super-admin/verify-reset-token/$token',
//       );
...
//       final response = await service.addItem(
//         endpointUrl: 'super-admin/register',
