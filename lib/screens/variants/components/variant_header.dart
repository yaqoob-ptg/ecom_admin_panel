    ...
    if (isMobileS) {
      return Column(
        ...
        children: [
          ...
          _VariantsSearchField(
            onChange: (val) => context.dataProvider.filterVariants(val),
          ),
        ],
      );
    }
...
class _VariantsSearchField extends StatelessWidget {
  final Function(String) onChange;
  const _VariantsSearchField({required this.onChange});
