    ...
    if (isMobileS) {
      return Column(
        ...
        children: [
          ...
          _VariantTypeSearchField(
            onChange: (val) => context.dataProvider.filterVariantTypes(val),
          ),
        ],
      );
    }
...
class _VariantTypeSearchField extends StatelessWidget {
  final Function(String) onChange;
  const _VariantTypeSearchField({required this.onChange});
