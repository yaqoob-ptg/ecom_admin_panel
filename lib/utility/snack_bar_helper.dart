...
// //     final double screenWidth = MediaQuery.of(context).size.width;
// //     final isWeb = screenWidth >= AppBreakpoints.webS;

// //     // ── Web-style positioning and sizing ─────────────────────────────────
// //     final EdgeInsets margin = isWeb
// //         ? const EdgeInsets.only(top: 24, right: 24, bottom: 0, left: 0)
// //         : EdgeInsets.symmetric(
// //             horizontal: screenWidth < AppBreakpoints.mobileL ? 16 : 40,
// //             vertical: 16,
// //           );

// //     final double maxWidth = isWeb ? 420 : double.infinity;

// //     // ── Font sizes ────────────────────────────────────────────────────────
// //     final double titleSize = isWeb ? 14.0 : 13.0;
// //     final double messageSize = isWeb ? 13.0 : 12.0;
// //     final double iconSize = isWeb ? 18.0 : 20.0;
...
// //       backgroundColor: backgroundColor,
// //       colorText: Colors.white,
// //       borderRadius: isWeb ? 100 : 12, // Pill shape for web
// //       margin: margin,
// //       duration: const Duration(seconds: 4),
// //       animationDuration: const Duration(milliseconds: 200),
// //       snackPosition: isWeb ? SnackPosition.TOP : SnackPosition.TOP,
// //       titleText: Text(
// //         title,
// //         style: TextStyle(
// //           color: Colors.white,
...
// //         ),
// //       ),
// //       icon: Icon(iconData, color: Colors.white, size: iconSize),
// //       shouldIconPulse: false,
// //       isDismissible: true,
...
// //       title: title,
// //       message: message,
// //       backgroundColor: const Color(0xFF059669), // Modern green
// //       iconData: Icons.check_circle_outline_rounded,
// //     );
// //   }
...
// //       title: title,
// //       message: message,
// //       backgroundColor: const Color(0xFFD97706), // Modern amber
// //       iconData: Icons.warning_amber_rounded,
// //     );
// //   }
...
//     // 1. Determine if we are on "Web/Desktop" or "Mobile"
//     // Using your AppBreakpoints.mobileL (768) as the cutoff
//     final bool isLargeScreen = screenWidth >= AppBreakpoints.mobileL;

//     // 2. Define the Web Toast width
//     const double toastWidth = 380.0;

//     // 3. Logic for Alignment
//     // On mobile: Standard centered margin
//     // On web: Large left margin to push it to the right corner
//     final EdgeInsets margin = isLargeScreen
//         ? EdgeInsets.only(
//             top: 20,
//             right: 20,
//             left: screenWidth - toastWidth - 20, // This forces it to the right
//           )
...
//       backgroundColor: backgroundColor,
//       colorText: Colors.white,
//       borderRadius: 8, // Web toasts usually have smaller radii
//       margin: margin,
//       maxWidth: isLargeScreen ? toastWidth : screenWidth * 0.95,
//       snackPosition: SnackPosition.TOP,
//       duration: const Duration(seconds: 4),

//       // Aesthetic tweaks for Web
//       boxShadows: [
//         BoxShadow(
//           color: Colors.black.withOpacity(0.2),
//           blurRadius: 8,
...
//           color: Colors.white,
//           fontWeight: FontWeight.bold,
//           fontSize: AppFontSize.md(context),
//         ),
//       ),
//       messageText: Text(
//         message,
...
//         ),
//       ),
//       icon: Icon(iconData, color: Colors.white, size: AppIconSize.md(context)),
...
//   // ... rest of your public API (showErrorSnackBar, etc.) stays the same ...
//   static void showErrorSnackBar(String message, {String title = "Error"}) {
//     _show(
//       title: title,
//       message: message,
...
class SnackBarHelper {
  static void _show({
    required String title,
    required String message,
    required Color accentColor, // The side-strip color
    required IconData iconData,
  }) {
    final context = Get.context;
    if (context == null) return;
    ...
    final double screenWidth = MediaQuery.of(context).size.width;
    final bool isMobile = screenWidth < AppBreakpoints.mobileL;
    ...
    Get.rawSnackbar(
      ...
      margin: EdgeInsets.only(
        top: 20,
        right: 20,
        // If mobile, keep it centered. If web, push it to the right.
        left: isMobile ? 20 : screenWidth - 420,
      ),
      backgroundColor: Colors.transparent, // We use the container color instead
      // elevation: 0,
      // contentPadding: EdgeInsets.zero,
      messageText: Container(
        decoration: BoxDecoration(
          // color: const Color(0xFF1E1E26), // Dark web-theme background
        ...
        // This ClipRRect creates the colored "status" strip on the left
        child: ClipRRect(
          borderRadius: BorderRadius.circular(8),
  ...
  // ── Public API ─────────────────────────────────────────────────────────────
  static void showSuccessSnackBar(String message) => _show(
        title: "Success",
        message: message,
  ...
  static void showErrorSnackBar(String message) => _show(
        title: "Error",
        message: message,
